...
namespace XLua.CSObjectWrap
{
    ...
    public class TestBlackListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(TestBlackList);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					TestBlackList gen_ret = new TestBlackList();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TestBlackList constructor!");
        ...
        static int _g_get_a1(RealStatePtr L)
        {
		    try {
                ...
                TestBlackList gen_to_be_invoked = (TestBlackList)translator.FastGetCSObj(L, 1);
