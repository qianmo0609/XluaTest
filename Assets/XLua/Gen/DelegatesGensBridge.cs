...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(XLua.LuaTable p0, int p1, int p2, int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action __Gen_Delegate_Imp12(XLua.LuaTable p0, int p1, int p2, int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action __Gen_Delegate_Imp14(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new Test.AddMethod(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(Test.addAc))
			{
			    return new Test.addAc(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(Test.test1))
			{
			    return new Test.test1(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(Test.test2))
			{
			    return new Test.test2(__Gen_Delegate_Imp14);
			}
