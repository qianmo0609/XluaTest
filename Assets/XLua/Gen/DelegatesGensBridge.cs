...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp15(XLua.LuaTable p0, int p1, int p2, int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action __Gen_Delegate_Imp16(XLua.LuaTable p0, int p1, int p2, int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action __Gen_Delegate_Imp18(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp20(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp25(object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp34(XLuaTest.StructTest p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp35(XLuaTest.StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp36(XLuaTest.StructTest p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(HotFixTest.testAction))
			{
			    return new HotFixTest.testAction(__Gen_Delegate_Imp11);
			}
		    ...
		    if (type == typeof(Test.AddMethod))
			{
			    return new Test.AddMethod(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(Test.addAc))
			{
			    return new Test.addAc(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(Test.test1))
			{
			    return new Test.test1(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(Test.test2))
			{
			    return new Test.test2(__Gen_Delegate_Imp18);
			}
